...
/**
 * NOTE: This fetcher was auto-generated by graphql-codegen but is NOT used at
 * runtime.  All Shopify Storefront calls go through /api/shopify (server-side
 * proxy) or the commerce adapter in src/lib/commerce/.
 *
 * Keeping the function shape so codegen typings still compile.
 */
