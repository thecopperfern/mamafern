      ...
      toast.success(
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-warm-brown">You just saved on shipping!</p>
          </div>
        </div>,
        {
          duration: 5000,
          ...
          >
            ...
            {(() => {
              ...
              return (
                <div className={`px-4 pt-4 pb-4 border-b-2 transition-colors ${
                  ...
                  <p className="text-xs text-charcoal/80 text-right mt-1">
            ...
            {cart.lines.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center gap-4 p-8">
                <ShoppingBag className="h-12 w-12 text-warm-brown" />
                <p className="text-warm-brown">Your cart is empty</p>
                <Button
                  onClick={onClose}
                ...
                <div className="border-t border-oat p-4 space-y-3">
                  ...
                  <div>
                    <button
                      ...
                      className="flex items-center gap-1 text-sm text-warm-brown hover:text-fern transition-colors"
                    >
